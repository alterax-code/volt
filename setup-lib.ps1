## VOLT - Phase D: Library Extraction (lib.rs) - v3
Write-Host "`n  VOLT - Extracting library...`n" -ForegroundColor Cyan

New-Item -ItemType Directory -Force -Path "examples" | Out-Null

$f0 = @'
//! # VOLT — A fast, expressive scripting language
//!
...
'@
[System.IO.File]::WriteAllText("$PWD/src/lib.rs", $f0)
Write-Host "  [OK] src/lib.rs" -ForegroundColor Green
...
'@
[System.IO.File]::WriteAllText("$PWD/src/main.rs", $f1)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/lexer/token.rs", $f2)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/lexer/mod.rs", $f3)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/parser/ast.rs", $f4)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/parser/mod.rs", $f5)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/vm/compiler.rs", $f6)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/vm/value.rs", $f7)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/vm/mod.rs", $f8)
Write-Host "  [OK] src/vm/mod.rs" -ForegroundColor Green

$f9 = @'
// Interpreter values (deprecated — replaced by VM NaN-boxing)
'@
[System.IO.File]::WriteAllText("$PWD/src/interpreter/value.rs", $f9)
Write-Host "  [OK] src/interpreter/value.rs" -ForegroundColor Green

$f10 = @'
// Tree-walking interpreter (deprecated — replaced by bytecode VM)
// Kept as module stub for potential future use.
'@
[System.IO.File]::WriteAllText("$PWD/src/interpreter/mod.rs", $f10)
...
'@
[System.IO.File]::WriteAllText("$PWD/examples/embed.rs", $f11)
Write-Host "  [OK] examples/embed.rs" -ForegroundColor Green

$f12 = @'
// ── VOLT Benchmark Suite ──
...
print("bench done")
'@
[System.IO.File]::WriteAllText("$PWD/tests/programs/bench.volt", $f12)
Write-Host "  [OK] tests/programs/bench.volt" -ForegroundColor Green


Write-Host "`n  Library extracted!" -ForegroundColor Cyan
Write-Host "  Test: cargo run -- run tests/programs/table_test.volt"
Write-Host "  Embed: cargo run --example embed"
