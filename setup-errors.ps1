## VOLT - Etape 9: Error Handling (v2)
Write-Host "`n  VOLT - Installing error handling...`n" -ForegroundColor Cyan
...
// → type test: 42
'@
[System.IO.File]::WriteAllText("$PWD/tests/programs/error_test.volt", $f12)
Write-Host "  [OK] tests/programs/error_test.volt" -ForegroundColor Green


Write-Host "`n  Error handling installed!" -ForegroundColor Cyan
Write-Host "  Test: cargo run -- run tests/programs/error_test.volt"
