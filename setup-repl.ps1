## VOLT - Etape 13: REPL (Final)
Write-Host "`n  VOLT - Installing REPL...`n" -ForegroundColor Cyan
...
Write-Host "`n  REPL installed! VOLT 1.0 complete!" -ForegroundColor Green
Write-Host ""
Write-Host "  Launch:  cargo run -- repl"
Write-Host "  Run:     cargo run -- run <file.volt>"
