## VOLT - Data Phase A: File I/O + Pipe Operator (v4)
Write-Host "`n  VOLT - Installing File I/O + Pipe...`n" -ForegroundColor Cyan
...
Write-Host "`n  File I/O + Pipe installed!" -ForegroundColor Cyan
Write-Host "  Test: cargo run -- run tests/programs/pipe_test.volt"
