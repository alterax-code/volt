## VOLT - Etape 10: Pattern Matching
Write-Host "`n  VOLT - Installing pattern matching...`n" -ForegroundColor Cyan
...
for i in 0..5
    match i % 3
        ...
        1 -> print(f"{i}:one")
        _ -> print(f"{i}:other")
// → 0:fizz 1:one 2:other 3:fizz 4:one
...
// → cool
'@
[System.IO.File]::WriteAllText("$PWD/tests/programs/match_test.volt", $f10)
Write-Host "  [OK] tests/programs/match_test.volt" -ForegroundColor Green

$f11 = @'
// ── VOLT Etape 9: Error Handling ──
...
// → type test: 42
'@
[System.IO.File]::WriteAllText("$PWD/tests/programs/error_test.volt", $f11)
Write-Host "  [OK] tests/programs/error_test.volt" -ForegroundColor Green
...
// → 15
'@
[System.IO.File]::WriteAllText("$PWD/tests/programs/closure_test.volt", $f12)
...
// → [1, 4, 9]
'@
[System.IO.File]::WriteAllText("$PWD/tests/programs/array_test.volt", $f13)
Write-Host "  [OK] tests/programs/array_test.volt" -ForegroundColor Green


Write-Host "`n  Pattern matching installed!" -ForegroundColor Cyan
Write-Host "  Test: cargo run -- run tests/programs/match_test.volt"
