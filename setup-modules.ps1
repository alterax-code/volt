## VOLT - Etape 11: Modules + Builtins (v2)
Write-Host "`n  VOLT - Installing modules...`n" -ForegroundColor Cyan

New-Item -ItemType Directory -Force -Path "tests/programs/mylib" | Out-Null
...
fn clamp(x, lo, hi)
    ...
    return x
'@
[System.IO.File]::WriteAllText("$PWD/tests/programs/mylib/math.volt", $f10)
Write-Host "  [OK] tests/programs/mylib/math.volt" -ForegroundColor Green
...
'@
[System.IO.File]::WriteAllText("$PWD/tests/programs/mylib/greet.volt", $f11)
Write-Host "  [OK] tests/programs/mylib/greet.volt" -ForegroundColor Green

$f12 = @'
// ── VOLT Etape 11: Modules + Builtins ──
...
describe("hello")
describe(3.14)
// → 42 is an integer, hello is a string, 3.14 is something else
...
// → 36
'@
[System.IO.File]::WriteAllText("$PWD/tests/programs/module_test.volt", $f12)
Write-Host "  [OK] tests/programs/module_test.volt" -ForegroundColor Green


Write-Host "`n  Modules installed!" -ForegroundColor Cyan
Write-Host "  Test: cargo run -- run tests/programs/module_test.volt"
