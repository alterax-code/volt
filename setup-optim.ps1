## VOLT - Phase C: Optimization + Cleanup (v2)
Write-Host "`n  VOLT - Installing optimizations...`n" -ForegroundColor Cyan
...
print("bench done")
'@
[System.IO.File]::WriteAllText("$PWD/tests/programs/bench.volt", $f10)
Write-Host "  [OK] tests/programs/bench.volt" -ForegroundColor Green


Write-Host "`n  Optimizations installed!" -ForegroundColor Cyan
Write-Host ""
Write-Host "  Benchmark (release):"
Write-Host "    cargo build --release"
Write-Host "    .\target\release\volt.exe run tests/programs/bench.volt"
