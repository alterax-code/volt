...
Write-Host "`n  VOLT - Installing closures & lambdas...`n" -ForegroundColor Cyan
...
'@
[System.IO.File]::WriteAllText("$PWD/src/lexer/token.rs", $file0)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/lexer/mod.rs", $file1)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/parser/ast.rs", $file2)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/parser/mod.rs", $file3)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/vm/compiler.rs", $file4)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/vm/value.rs", $file5)
        ...
        loop {
            ...
            match op {
                ...
                OP_CALL_VALUE => {
                    ...
                    // Shift args down to overwrite closure slot
...
'@
[System.IO.File]::WriteAllText("$PWD/src/vm/mod.rs", $file6)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/interpreter/value.rs", $file7)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/interpreter/mod.rs", $file8)
...
'@
[System.IO.File]::WriteAllText("$PWD/src/main.rs", $file9)
...
// → 15
'@
[System.IO.File]::WriteAllText("$PWD/tests/programs/closure_test.volt", $file10)
Write-Host "  [OK] tests/programs/closure_test.volt" -ForegroundColor Green

Write-Host "`n  Done! Run: cargo run -- run tests/programs/closure_test.volt" -ForegroundColor Cyan
